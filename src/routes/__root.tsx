...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Reliable lubricant supply and energy solutions for industries across Nigeria." },
      { name: "author", content: "Fort-Star Energy Resources Nigeria Limited" },
      ...
      { name: "twitter:site", content: "@FortStarEnergy" },
    ],
    links: [
      {
        rel: "stylesheet",
